                    ...
                    <Table style={{ width: '100%' }}>
                        <TableHead>
                            <TableRow>
                                ...
                                <TableCell align="left" sx={{ width: '10%' }}><Typography variant="h6">Name</Typography></TableCell>
                                <TableCell align="left" sx={{ width: '30%' }}><Typography variant="h6">Description</Typography></TableCell>
                                <TableCell align="left" sx={{ width: '30%' }}><Typography variant="h6">External link</Typography></TableCell>
                                <TableCell align="left" sx={{ width: '20%' }}><Typography variant="h6">Date</Typography></TableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>
                            {displayData.map((elem, index) => (
                                <TableRow key={index}>
                                    ...
                                    <TableCell align="left"> <Link href={"/nft-detail/" + elem?.contractAddr + "/" + elem?.tokenId}> {cutStringAfterWords(elem?.name, 5)} </Link></TableCell>
                                    <TableCell align="justify"> {cutStringAfterWords(elem?.description, 40)}</TableCell>
                                    {elem?.external_link ?
                                        (<TableCell align="left"> <Link href={elem?.external_link} target="_blank">{cutStringAfterChars(elem?.external_link, 40)}</Link></TableCell>) :
